...
while True:
        ...
        for handLms in results.multi_hand_landmarks:
            ...
            if distance_0to2 / hand_size < distance_threshold and distance_0to3 / hand_size < distance_threshold:
                ...
                if len(positions) > 1 and moving:
                    ...
                    mouse_move_x = current_mouse_x + avg_motion_distance_x * kando
                    mouse_move_y = current_mouse_y + avg_motion_distance_y * kando
    ...
    cv2.putText(img, f'Bool: {not(moving)}', (10, 140), cv2.FONT_HERSHEY_PLAIN, 3, (255, 0, 255), 3)
